...
We plan to use:
\begin{itemize}
    \item ROUGE-1, ROUGE-2, and ROUGE-L for lexical overlap,
    \item BERTScore for semantic similarity,
    \item and simple structural measures such as section count difference and article length ratio.
\end{itemize}

Since exact wording may differ even in a good reconstruction, we will not rely on a single metric, but combine overlap, and semantic similarity.
